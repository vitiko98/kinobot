...
def get_rec(json_path):
    with open(json_path) as f:
        ...
        names, text_length = prettify_list(pick_four)
        ...
        new_w = int(h * 0.23)
        new_h = 50
        w_text = get_collage_w_text(final, w, h, new_h, new_w, fg, bg, names, text_length)
        return decorate_info(w_text, decorators[0], decorators[1], fg, new_w, new_h)
